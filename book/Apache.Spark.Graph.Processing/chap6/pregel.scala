...
object BallGameApp {
    def main(args: Array[String]){
        ...
        */
        ...
        def averageConcededStat(graph: Graph[String, FullResult])(getStat: GameStats => Double, rxs: Teams): VertexRDD[Double] = {
            type Msg = (Int, Double)
            val aggrStats: VertexRDD[Msg] = graph.aggregateMessages[Msg](
                // sendMsg
                rxs match {
        ...
        // Conceded points by all teams
        val avgConcededPoints = averageConcededStat(scoreGraph)(score, AllTeams())
        ...
        def avgConcededFreeThrows = averageConcededStat(scoreGraph)(threeThrowPoints, AllTeams())
        val avgConcededFreeThrowsAttempt = averageConcededStat(scoreGraph)(threeThrowPointsAttempts, AllTeams())        
